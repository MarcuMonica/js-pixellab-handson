...
console.warn(`
Afiseaza suprafata totala a unor dreptunghiuri de 5
pe 3, respectiv 3 pe 2. Foloseste variabile.
`);
...
console.warn(`
Afiseaza suprafata totala a trei dreptunghiuri de 15 pe 31,  8 pe 9, respectiv 10 pe 5.
Foloseste variabile.
`);
...
const totalRectangleSum = rectangle1 + rectangle2 + rectangle3;
console.log(totalRectangleSum);
