...
console.warn(`
Afiseaza ultimele doua cifre al anului de nastere al persoanei, folosind anul curent si
metoda getAge(). (Exemplu: ‘87).
`);
...
`);
const birthYear2 = new Date().getFullYear() - person.getAge();
console.log(`M-am nascut in ${birthYear2}.`);

console.warn(`
Afiseaza propozita: “Ma numesc xxx yyy m-am nascut acum aa ani in anul zzzz!”
`);
console.log(
  `Ma numesc ${person.getName()} m-am nascut acum ${person.getAge()} ani in anul ${birthYear2}!`,
);
