  ...
  toggleHazards() {
    if (this.areHazardsOn === true) {
      ...
      if (this.isLightOn === true) {
        ...
        this.lightFront.classList.remove('light--off');
      }
      return;
    }
    const self = this;
...
const car00 = new Car(250, 250, 'blue', 'red', 'green');
car00.render().changeCapColor('silver').changeTireColor('gold');
const car01 = new Car(250, 16, 'red');
car01.render().moveTo(100, 100);
const car02 = new Car(16, 250, 'blue');
car02.render().toggleHazards();
const car03 = new Car(16, 16, 'purple');
